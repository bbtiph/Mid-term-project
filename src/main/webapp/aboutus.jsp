    ...
    <div class="panel panel-default" style="width:1320px;">
        <div class="panel-body">
            ...
            <p style="position: relative; float: left; width: 1000px;">Ginger
                ...
                of budget hotels in KZ. One of the leading brands in the
                hospitality segment, Almaty has rapidly grown in major urban and
                semi-urban cities across KZ to be an ideal choice for leisure
            ...
            <p style="position: relative; float: left; width: 1000px;">Explore
                a new city in KZ with Almaty Hotels, where you can experience a
            ...
            <div
                ...
                <center>
                    <img src="1.jpg" width="235px" height="250px"
            ...
            <div
                    style="float: left; margin-left: 40px; width: 300px; height: 300px;">
                <center>
                    <img src="2.jpg" width="235px" height="250px"
                         style="margin-top: 5px;" />
                </center>
                <center>
            ...
            <div
                    style="float: left; margin-left: 40px; width: 300px; height: 300px;">
                <center>
                    <img src="3.jpg" width="235px" height="250px"
                         style="margin-top: 5px;" />
                </center>
                <center>
            ...
            <div
                    style="float: left; margin-left: 40px; width: 300px; height: 300px;">
                <center>
                    <img src="4.jpg" width="235px" height="250px"
                         style="margin-top: 5px;" />
                </center>
                <center>
            ...
            <div
                    style="float: left; margin-left: 40px; width: 300px; height: 300px;">
                <center>
                    <img src="5.jpg" width="235px" height="250px"
                         style="margin-top: 5px;" />
                </center>
                <center>
            ...
            <div
                    style="float: left; margin-left: 40px; width: 300px; height: 300px;">
                <center>
                    <img src="6.jpg" width="235px" height="250px"
                         style="margin-top: 5px;" />
                </center>
                <center>
